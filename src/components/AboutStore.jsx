function AboutStore() {
  return (
    <div className="flex lg:px-48 pt-40 px-16 h-[40rem] overflow-hidden">
      <div className="flex flex-col px-6 md:px-16 lg:px-24 flex-1 text-center md:text-left bg-stone-200 items-center md:items-start justify-center gap-4">
      ...
      <div className="overflow-hidden hidden md:block  ">
        <img
          ...
          alt=""
          className=" h-full lg:object-cover"
        />
      </div>
    </div>
  );
